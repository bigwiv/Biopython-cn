...
population information (but there is more 每 use help(GenePop.Record) to
...
Computations 每 ABC) it is important to test many parameter variations
...
including the typical 每 for microsatellites 每 stepwise mutation model
among others).
...
other elements, please refer to the pv documentation 每 for the sake of
