Chapter?21??Where to go from here 每 contributing to Biopython
=============================================================
...
-  `biopython@biopython.org <mailto:biopython@biopython.org>`__ 每 An
...
-  `biopython-dev@biopython.org <mailto:biopython-dev@biopython.org>`__
   每 A more development oriented list that is mainly used by developers
...
**Windows**
    每 Windows products typically have a nice graphical installer that
...
**RPMs**
    每 RPMs are pretty popular package systems on some Linux platforms.
    ...
    (having a C compiler that works is thus essential) 每 see the
...
**Macintosh**
    每 Since Apple moved to Mac OS X, things have become much easier on
...
to express an interest is on the Biopython mailing lists 每 just let us
...
coding them, since that helps generate good ideas 每 then just feel free
